...
c0 = Mahasiswa('Franco',20,'Jakarta',540000)
c1 = Mahasiswa('Selina',31,'Bekasi',130000)
c2 = Mahasiswa('Alice',12,'Surakarta',550000)
c3 = Mahasiswa('Santos',33,'Tangerang',245000)
c4 = Mahasiswa('Tisna',24,'Boyolali',210000)
c5 = Mahasiswa('Puji',41,'Ciamis',220000)
c6 = Mahasiswa('Roti',23,'Jogja',145000)
c7 = Mahasiswa('Rafael',23,'Jaten',445000)
c8 = Mahasiswa('Romi',23,'Serambi',155000)
c9 = Mahasiswa('Paiji',24,'Plaos',170000)
c10 = Mahasiswa('Aston',49,'Skandanavia',125000)
